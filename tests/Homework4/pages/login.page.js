...
exports.LoginPage = class loginPage {
    constructor(page) {
        ...
        this.alertText = page.locator('.oxd-text.oxd-text--p.oxd-alert-content-text');
    }
    ...
    async invalidLoginOrangeHr(username, password) {
        await this.page.goto('https://opensource-demo.orangehrmlive.com/web/index.php/auth/login');
        await this.nameField.fill(username);
        await this.passwordField.fill(password);
        await this.loginButton.click();
        await expect(this.alertText).toHaveText('Invalid credentials');
    }
